...
export default function Home() {
  return (
    ...
    >
      ...
      <h2 
      style={{fontSize: '14px', color: 'black', textAlign: 'center',  paddingTop: '15px', paddingBottom: '20px' }}>
        ...
        <h3
          style={{fontSize: '15px', font: 'normal', textAlign: 'left', paddingLeft: '65px', paddingTop: '15px'}}
          >
