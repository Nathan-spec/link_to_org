...
export default function Home() {
  return (
    ...
    >
      ...
      <h1 
      style={{fontSize: '28px',font: 'bolder', color: 'black', textAlign: 'center' }}> 
        Link Your Organization to your bank 
      </h1>
      <h2 
      style={{fontSize: '16px', color: 'black', textAlign: 'center',  paddingTop: '15px', paddingBottom: '20px' }}>
        ...
        <h2
          style={{fontSize: '20px', font: 'bold', color: 'black', textAlign: 'left', paddingLeft: '65px', paddingTop: '30px'}}>
         Account Number
        </h2>
        <h3
          style={{fontSize: '15px', font: 'normal', textAlign: 'left', paddingLeft: '65px', paddingTop: '5px'}}
          >
